...
def main ():
    ...
    img.perform_operation_no_shift(normalized_sobel_kernel_Gx)
    ...
    img2.perform_operation_no_shift(normalized_sobel_kernel_Gy)
    ...
    img3.calculate_gradient_magnitude_no_shift(img, img2)

    #img.show_image('sobel operator Gx')

    print('\n Gx Max ---> ', img.max_value)
    print('\n Gx Min ---> ', img.min_value)

    #img2.show_image('sobel operator Gy')

    print('\n Gy Max ---> ', img2.max_value)
    print('\n Gy Min ---> ', img2.min_value)

    #img3.show_image('sobel magnitude')
    ...
    img.write_image('sobelGx')
    img2.write_image('sobelGy')
    img3.write_image('sobelGM')
    img3.write_image('GM')
    #imgThresh1.write_image('boundaryDetection1sobel')
    imgThresh2.write_image('boundaryDetection1sobel')
    imgThresh3.write_image('boundaryDetection2sobel')
